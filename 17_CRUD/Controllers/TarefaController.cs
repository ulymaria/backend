...
namespace _17_CRUD.Controllers
{
  ...
  public class TarefaController : Controller
  {
    ...
    {
      //Verificando o total de tarefas da lista e somando mais 1 para0 ID
      novaTarefa.Id = _tarefas.Count + 1;
      //Adionando minha nova tarefa à minha lista
      _tarefas.Add(novaTarefa);
      //Redirecionando para a página com a lista de tarefas 
    ...
    [HttpPost]
    public IActionResult Deletar(Tarefa tarefaDelendo)
    {
      Tarefa tarefaDB = _tarefas.Find(t => t.Id == tarefaDelendo.Id);
      if (tarefaDB == null)
        return NotFound();
